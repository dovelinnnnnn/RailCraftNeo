...
@Mod.EventBusSubscriber(modid = RailcraftNeo.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config
{
...
//    static final ModConfigSpec SERVER = SERVER_BUILDER.build();
//    static final ModConfigSpec CLIENT = CLIENT_BUILDER.build();
...
//        public final ModConfigSpec.ConfigValue<List<? extends String>> cargoBlacklist;
        ...
        public final ModConfigSpec.DoubleValue boreMininigSpeedMultiplier;
        public final ModConfigSpec.BooleanValue boreDestorysBlocks;
...
////                    .defineList("cargoBlacklist",obj -> ResourceLocation.isValidResourceLocation(obj.toString()), Config::validateItemName);
//                    .defineListAllowEmpty("cargoBlacklist", List.of("Railcraftneo:cargo_blacklist"), Config::validateItemName);
