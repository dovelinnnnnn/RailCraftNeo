...
public class Translations {
  public static class Tab {
    ...
    public static final String RAILCRAFTNEO = "itemGroup." + MODID;
    public static final String RAILCRAFT_OUTFITTED_TRACKS = RAILCRAFTNEO + "_outfitted_tracks";
    public static final String RAILCRAFT_DECORATIVE_BLOCKS = RAILCRAFTNEO + "_decorative_blocks";
  }
